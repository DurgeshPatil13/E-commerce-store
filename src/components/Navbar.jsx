...
{/* search */}
<input   value={search}
  onChange={(e) => setSearch(e.target.value)}  type="text" placeholder='🔍 Search for products'  className='w-250 pl-3 bg-white rounded-2xl  border-blue-300 border-2 outline-none '/>
{/* cart whislist */}
